...
const pricing = [
  { product: "Single Verification", unit: "per title", price: "KES 3,000", priceGBP: "~£18", desc: "Full 6-check verification with Trust Score and certificate" },
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-6 rounded-xl border border-ardhi/20 bg-ardhi/5 p-5 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted">A bank auditing 10,000 titles at the bulk rate: <strong className="text-navy">KES 15M (~£90K)</strong>. This replaces 3-6 months of manual verification costing KES 50M+ (~£300K).</p>
            </div>
          </div>
        </div>
      </section>
