      ...
      <section className="relative overflow-hidden bg-navy px-4 pb-16 pt-20 sm:pb-20 sm:pt-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/hatiscan"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-ardhi px-8 py-4 text-lg font-semibold text-white transition-colors hover:bg-ardhi-dark"
            >
